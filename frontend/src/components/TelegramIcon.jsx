/**
 * Иконка Telegram (официальный логотип) для ссылок на профиль/чат.
 * Использование: <TelegramIcon /> или <TelegramIcon width={20} height={20} className="..." />
 */
export default function TelegramIcon({ width = 24, height = 24, className = '', ...props }) {
  return (
    <svg
