...
* **Uptime-check (OPS-03):** Допущение: два подряд неуспешных проверки перед отправкой уведомления для снижения ложных срабатываний (см. [16-ops02-ops03-graceful-uptime.md](16-ops02-ops03-graceful-uptime.md)).
