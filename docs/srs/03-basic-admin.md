...
* **голосование_в_ОСС:** связь с контактом (contact_id), barrier_vote (позиция по шлагбаумам: `for` | `against` | `undecided`), vote_format (формат голосования: `electronic` | `paper` | `undecided`), проголосовал (bool). Данные по участию в ОСС и голосовании.
