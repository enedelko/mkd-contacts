...
Соответствие SRS: [docs/srs/00-INDEX.md](srs/00-INDEX.md). Реализованные спецификации — 02–06, 10; остальные фичи — [98-backlog.md](srs/98-backlog.md).
...
| **UI-01** | EntrancePicker: переиспользуемый компонент выбора подъезда (кнопки, бар, загрузка, сброс). Рефакторинг AdminContactsList, Upload. | Средний | FE-03 | Планирование |
| **FE-06** | Главная: шахматка помещений по этажам; в ячейке — тип, номер, иконки ТГ/email, цвет по ОСС; клик → форма контакта или /admin/contacts. | Высокий | UI-01, FE-02, FE-04, ADM-03 | Планирование |
...
| **ADM-02** | Модерация: таблица контактов с фильтрами (IP, TimeRange), пакетный перевод в «Неактуальные». | Средний | BE-03, ADM-01 | Бэклог |
