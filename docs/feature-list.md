...
Соответствие SRS: [docs/srs/00-INDEX.md](srs/00-INDEX.md). Реализованные спецификации — 02–15 (в т.ч. BOT-01…04). Отменённые — [97-cancelled.md](srs/97-cancelled.md); бэклог — [98-backlog.md](srs/98-backlog.md).
