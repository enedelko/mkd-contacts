...
Соответствие SRS: [docs/srs/00-INDEX.md](srs/00-INDEX.md). Реализованные спецификации — 02–16 (в т.ч. BOT-01…04, OPS-02, OPS-03). Отменённые — [97-cancelled.md](srs/97-cancelled.md); бэклог (OPS-01) — [98-backlog.md](srs/98-backlog.md); OPS-02, OPS-03 — [16-ops02-ops03-graceful-uptime.md](srs/16-ops02-ops03-graceful-uptime.md).
...
| **FE-06** | Главная: шахматка по этажам (номер этажа перед каждым рядом, краткий тип помещения); цвета в CSS (полная палитра / упрощённая для гостя); печать: заголовок «Подтверждение собственности в ЭД», монохром, крест для подтверждённых; клик → форма или /admin/contacts. | Высокий | UI-01, FE-02, FE-04, ADM-03 | Готово |
