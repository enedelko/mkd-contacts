...
Соответствие SRS: [docs/srs/00-INDEX.md](srs/00-INDEX.md). Реализованные спецификации — 02–15 (в т.ч. BOT-01…04); остальные фичи — [98-backlog.md](srs/98-backlog.md).
...
| **FE-01** | SVG-навигация: 3 уровня (подъезд → этаж → помещение), id = cadastral_number. | Высокий | CORE-01 | Cancelled |
| **FE-02** | Легенда на карте: 5 состояний (нет данных, невалидированные, часть/все валидированы, выбранное). | Высокий | CORE-04, FE-01 | Cancelled |
...
| **OPS-01** | Резервное копирование: ежедневные дампы на S3 (глубина 14 дней). | Низкий | BE-01 | Готово |
