...
| Категория | Поля | Примечание |
|-----------|------|------------|
| Контактные данные | телефон, email, telegram_id | Если присутствуют в файле |
| Обращение | как обращаться к собственнику | Опционально (например: «Иван Иванович», «г-н Петров») — ПДн |

Минимально обязательные для строки с контактом — хотя бы одно из: телефон, email, telegram_id. Остальные ПДн, в т.ч. «как обращаться», — опционально по колонкам файла.
